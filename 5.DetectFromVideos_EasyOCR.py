...
def main():
   ...
   ############ Apply OCR to Detection ############
    ...
    windowname = "Detect From Video File"
    cv2.namedWindow(windowname)
    cap = cv2.VideoCapture('./samples/sampleVideo1.mp4')
    ...
    VideoOutPut = cv2.VideoWriter(filename, codec, fps_input, resolution)
    ...
    while cap.isOpened(): 
        ...
        if ret:
            ...
            try: 
                ...
                save_results(text, region, roi, boxes, scores, classes, './output/DetectionFromVideos.csv', './output/Detection_From_Videos')
            ...
            cv2.imshow(windowname,  cv2.resize(image_np_with_detections, (width, height)))
    ...
    print("Video Output File Name: ", filename, "\n")
